...
const ModalDetailK3S = ({ isOpen, onClose }) => {
  const [tabIndex, setTabIndex] = useState(0);

  const chartData = {
    x: ['1', '2', '3', '4', '5', '6', '7', '8', '9'],
    y: [750, 650, 800, 700, 750, 680, 720, 600, 750],
    type: 'bar',
    marker: { color: 'blue' },
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="5xl" scrollBehavior="inside">
      ...
      <ModalContent maxHeight="80vh">
        <ModalHeader>KKKS01 - Wilayah Kerja AREA001</ModalHeader>
        <ModalCloseButton />
          ...
          <Box mb={4}>
            ...
            >
              ...
              <Marker position={[0.0, 100.0]}>
                <Popup>Wilayah Kerja AREA001</Popup>
              </Marker>
            </MapContainer>
          </Box>
