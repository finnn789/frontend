...
const WellCasing = ({
  ...
  const [editIndex, setEditIndex] = useState(null);
    ...
    const prevTableRef = useRef(); // Gunakan ref untuk menyimpan table sebelumnya
...
// Periksa apakah `tableWellCasing` benar-benar berubah sebelum memanggil `handleChange`
useEffect(() => {
    if (JSON.stringify(tableWellCasing) !== JSON.stringify(prevTableRef.current)) {
      if (handleChange) {
        handleChange(tableWellCasing);
      }
      prevTableRef.current = tableWellCasing; // Perbarui ref table sebelumnya
    }
